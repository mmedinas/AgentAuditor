...
# --- Prompt Mestre (REFORÇADO COM FRAMING) ---
MASTER_PROMPT = """
...
with st.sidebar:
    ...
    # REMOVIDO: Botão de Auditoria de Desenhos
    ...
    if valid:
        try:
            ...
            if st.session_state.read_error: st.error(st.session_state.read_error) # Exibe erro de leitura
                ...
                prompt_template = ChatPromptTemplate.from_template(MASTER_PROMPT) # Usa o prompt único
